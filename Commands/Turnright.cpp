...
Turnright::Turnright()
{
   ...
   m_PIDcontroller = new PIDController(P_DEFAULT, I_DEFAULT, D_DEFAULT, 
                                       Robot::orientation->gyro, Robot::drivetrain);
...
Turnright::Turnright(float p, float i, float d)
{
   ...
   // set a time out for the command in case the set point cannot be reached
   SetTimeout(10.0);
...
bool Turnright::IsFinished() 
{
   ...
   // return true when on target ro command timed out
