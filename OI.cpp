...
#include "Commands/TurnRightGroup.h"
...
{   
   ...
   ((Turnright*)turnRight)->SetPID(DRIVE_TRAIN_P_DEFAULT, DRIVE_TRAIN_I_DEFAULT, DRIVE_TRAIN_D_DEFAULT);
   ...
   // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
	...
	leftJoystickTrigger->WhenPressed(new TurnDegrees());
	...
	SmartDashboard::PutData("Turn Right Group", new TurnRightGroup());
	SmartDashboard::PutData("Autonomous Command", new AutonomousCommand());
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
	SmartDashboard::PutData("Turn Degrees", new TurnDegrees(10.0f));
}
